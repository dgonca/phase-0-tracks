...
#the two different hash syntaxes are how the key and values are distinguished. the : and => are the different ways to signal a symbol
# What does require_relative do? How is it different from require?
#require_relative looks in the same directory as the file, require needs a direct path to another file
# What are some ways to iterate through a hash?
#each, while, until
# When refactoring virus_effects, what stood out to you about the variables, if anything?
#instance variables can be used anywhere, you dont have to call them in as arguments
# What concept did you most solidify in this challenge?
#definitely working with files that are bringing in data structures and using them in classes

...
#the two different syntaxes are the different ways of writing the hash - with the big hash, organizing all the state names,
#for the keys strings are used and the => syntax into a value which is the second hash. That second hash is stored in the symbols to values
#way. STATE_DATA is a constant variable where you are saying you want to keep this information from not changing. When setting this in other
#languages, the program actually doesn't let you change it, but ruby is a bit more flexible. 
#The scope of STATE_DATA is this directory. 
